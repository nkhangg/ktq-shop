...
import KtqUserBlackListLog from "./ktq-user-black-list-logs.entity";

@Entity("ktq_user_black_lists")
@Unique("UQ_KTQ_USER_BLACK_LISTS_USER_ROLE_TYPE_USER_ID_APP", [
  "user_role_type",
  "user_id_app",
])
export default class KtqUserBlackList {
  ...
  @OneToMany(
    () => KtqUserBlackListLog,
    (userBlackListLog) => userBlackListLog.userBlackList,
  )
  //@Exclude()
  userBlackListLogs: KtqUserBlackListLog[];
}
