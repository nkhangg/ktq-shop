...
import { LoginKtqAdminUserDto, LoginKtqCustomerDto, RefreshTokenDto, RegisterKtqAdminUserDto, RegisterKtqCustomerDto } from '@/common/dtos/ktq-authentication.dto';
...
export class KtqAuthenticationsService {
    ...
    async getCurrentCustomerProfile(tokenData: TTokenData) {
        ...
        return KtqResponse.toResponse(customer, { message: 'Profile was got' });
    }
}
