...
@Injectable()
export class KtqWebsitesService implements ServiceInterface<KtqWebsite, Partial<KtqWebsite>> {
    constructor(
    ...
    async update(id: KtqWebsite['id'], website: Partial<KtqWebsite>): Promise<KtqWebsite> {
